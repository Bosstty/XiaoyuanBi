...
const routes: RouteRecordRaw[] = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                meta: { title: '登录', guest: true, level: 1, hideNavBar: true, hideTabBar: true },
            },
            {
                path: 'register',
                name: 'Register',
                component: () => import('@/views/auth/RegisterMobile.vue'),
                meta: { title: '注册', guest: true, level: 1, hideNavBar: true, hideTabBar: true },
            },
            {
                path: 'auth/forgot-password',
                name: 'ForgotPassword',
                component: () => import('@/views/auth/ForgotPassword.vue'),
                meta: { title: '忘记密码', guest: true, level: 1, hideNavBar: true, hideTabBar: true },
            },
            {
                path: 'settings',
                name: 'Settings',
